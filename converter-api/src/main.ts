...
async function bootstrap(): Promise<void> {
  ...
  const swaggerConfig = new DocumentBuilder()
    ...
    .setDescription(
      'Microservice for converting documents (PDF/DOCX/PPTX/XLSX/TXT) and images (PNG/JPG/WebP)',
    )
    .setVersion('0.1.0')
    .addTag('FileConverter', 'File conversion operations')
  ...
  logger.log(`File Converter API running at ${baseUrl}`);
