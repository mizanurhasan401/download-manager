...
export const PROVIDER_REGISTRY: readonly ProviderDefinition[] = [
  ...
  {
    id: VideoProviderEnum.INSTAGRAM,
    label: 'Instagram',
    brandColor: '#E4405F',
    iconKey: 'instagram',
...
export function getAllProviderDomains(): readonly string[] {
  return Array.from(HOSTNAME_INDEX.keys());
}
